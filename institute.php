    ...
    <div class=" institute-head-box px-4 py-3 atlas-row  d-flex flex-column gap-4 ">
        <div class="d-flex flex-row justify-content-between">
            <div class="breadcrumbs text-white">
                ...
                <a class="text-white"
                    href="<?= atlas_base_url('province='.$province_id) ?>"><?php echo $province_neme ?></a>
                <img class="search-button" src="<?php echo atlas_panel_image('arrow.svg') ?>">
                <a class="text-white" href="<?= atlas_base_url('city='.$city_id) ?>/"><?php echo $city_neme ?></a>
                <img class="search-button" src="<?php echo atlas_panel_image('arrow.svg') ?>">
                <span class="text-white-50"><?php echo get_the_title($post_id) ?></span>
            </div>
            <div class="text-white atlas-share">
                <?php if (! empty($link[ 'instagram' ])): ?>
                <a href="<?php echo $link[ 'instagram' ] ?>" class="py-1 border border-warning rounded-circle"><img
                        class="m-1" src="<?php echo atlas_panel_image('instagram.png') ?>"></a>
                <?php endif; ?>

                <?php if (! empty($link[ 'telegram' ])): ?>
                <a href="<?php echo $link[ 'telegram' ] ?>" class="py-1 border border-warning rounded-circle"><img
                        class="m-1" src="<?php echo atlas_panel_image('telegram.png') ?>"></a>
                <?php endif; ?>

                <?php if (! empty($link[ 'rubika' ])): ?>
                <a href="<?php echo $link[ 'rubika' ] ?>" class="py-1 border border-warning rounded-circle"><img
                        class="m-1" src="<?php echo atlas_panel_image('rubika.png') ?>"></a>
                <?php endif; ?>

                <?php if (! empty($link[ 'bale' ])): ?>
                <a href="<?php echo $link[ 'bale' ] ?>" class="py-1 border border-warning rounded-circle"><img
                        class="m-1" src="<?php echo atlas_panel_image('bale.png') ?>"></a>
                <?php endif; ?>

                <?php if (! empty($link[ 'eitaa' ])): ?>
                <a href="<?php echo $link[ 'eitaa' ] ?>" class="py-1 border border-warning rounded-circle"><img
                        class="m-1" src="<?php echo atlas_panel_image('eitaa.png') ?>"></a>
                <?php endif; ?>

                <?php if (! empty($link[ 'site' ])): ?>

                <a href="<?php echo $link[ 'site' ] ?>" class="py-1 border border-warning rounded-circle"><img
                        class="m-1" src="<?php echo atlas_panel_image('web.png') ?>"></a>
                <?php endif; ?>

                <?php if (! empty($phone)): ?>
                <a href="tel:<?php echo $phone ?>" class="py-1 border border-warning rounded-circle"><img class="m-1"
        ...
        <div class="d-flex justify-content-center my-2">
            ...
            <div class=" p-2">
                <img class="mb-2 rounded-circle" src="<?php echo $img ?>">
...
<div class="container-fluid mt-2 institute-info  ">
    <div class="atlas-row px-4 py-3">
        ...
        <div class="row">
            <div class="col-6 d-flex flex-row gap-2 justify-content-start align-content-center mb-3">
                ...
                <div class="d-flex flex-row gap-2 justify-content-center align-content-center">
                    <div class="px-3 py-1 rounded bg-white atlas_page_item fw-bold">
                        <?php echo($center_mode == 'public') ? 'عمومی' : 'خصوصی'; ?></div>
...
<div class="container-fluid mt-2 institute-block  ">
    <div class="atlas-row px-4 py-3">
        ...
        <hr class="">
        <div class="d-flex flex-row gap-2 justify-content-start align-content-center">
...
<div class="container-fluid mt-2 institute-block  ">
    <div class="atlas-row px-4 py-3">
        <p class="atlas-title fw-bold"><img src="<?php echo atlas_panel_image('edu.svg') ?>"> دوره
            های فعال</p>
        <hr class="">
        <div class="d-flex flex-row gap-2 justify-content-start align-content-center">
...
<div class="container-fluid mt-2 institute-block  mb-5">
    <div class="atlas-row px-4 py-3">
        ...
        <hr class="">
        <div class="row">
            <div class="col-6 atlas-contact d-flex flex-column gap-4">
                <div>
            ...
            <div class="col-6">
                <div id="map-city" class="rounded " style="height: 500px;"></div>
            </div>
        </div>
    </div>
</div>
