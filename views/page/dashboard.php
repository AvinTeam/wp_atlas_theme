...
<div class="container-fluid bg-white px-5 py-2">
    <div class="d-flex flex-row justify-content-between align-items-start mx-auto atlas-row my-2">
        <div class="d-flex flex-row justify-content-start align-items-center gap-2">
            <a class="btn btn-light" href="/atlas/panel/">داشبورد</a>
            <span><?php echo $this_user->nickname ?> خوش آمدید!  ( <a class="btn btn-link p-0 m-0" href="/atlas/panel/?profile">ویرایش</a> )</span>


        </div>

        <div class="d-flex flex-row justify-content-end align-items-center gap-2">
            <a class="btn btn-light" href="/">بازگشت به صفحه نخست</a>
