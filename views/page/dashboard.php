...
<div class="container-fluid bg-white px-5 py-2">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center mx-auto atlas-row my-2">
        <div class="d-flex flex-column flex-lg-row justify-content-start align-items-center gap-2">
            ...
            <span class="text-center"><?php echo $this_user->nickname ?> خوش آمدید! <br class="d-block d-lg-none"> ( <a
                    class="btn btn-link p-0 m-0" href="<?php echo atlas_base_url('panel/?profile') ?>">ویرایش</a>
                )</span>
        </div>

        <div class="d-flex flex-column flex-lg-row justify-content-end align-items-center gap-2">
