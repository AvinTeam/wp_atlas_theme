                    ...
                    <tr>
                        ...
                        <td>
                            <input name="notificator_token" type="text" id="notificator_token"
                                value="<?=$atlas_option[ 'notificator_token' ]?>" class="regular-text">
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="tsms[username]" type="text" id="tsms_username"
                                value="<?=$atlas_option['tsms'][ 'username' ]?>" class="regular-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="tsms[password]" type="text" id="tsms_password"
                                value="<?=$atlas_option['tsms'][ 'password' ]?>" class="regular-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="tsms[number]" type="text" id="tsms_number"
                                value="<?=$atlas_option['tsms'][ 'number' ]?>" class="regular-text">
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="ghasedaksms[ApiKey]" type="text" id="ghasedaksms_ApiKey"
                                value="<?=$atlas_option['ghasedaksms'][ 'ApiKey' ]?>" class="regular-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="ghasedaksms[number]" type="text" id="ghasedaksms_number"
                                value="<?=$atlas_option['ghasedaksms'][ 'number' ]?>" class="regular-text">
                        </td>
                    </tr>
                </tbody>
            </table>
